(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["react-highlight-words"] = factory(require("react"));
	else
		root["react-highlight-words"] = factory(root["react"]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _memoizeOne = __webpack_require__(12);
	...
	Highlighter.propTypes = {
	  ...
	  searchWords: _propTypes2['default'].arrayOf(_propTypes2['default'].oneOfType([_propTypes2['default'].object, _propTypes2['default'].string, _propTypes2['default'].instanceOf(RegExp)])).isRequired,
...
/***/ (function(module, exports) {
	...
	var findAll = function findAll(_ref) {
	  ...
	  var _ref$caseSensitive = _ref.caseSensitive;
	  var caseSensitive = _ref$caseSensitive === undefined ? false : _ref$caseSensitive;
	  var _ref$findChunks = _ref.findChunks;
	  var findChunks = _ref$findChunks === undefined ? defaultFindChunks : _ref$findChunks;
	  var sanitize = _ref.sanitize;
	  var searchWords = _ref.searchWords;
	  var textToHighlight = _ref.textToHighlight;
	 ...
	 */
	var combineChunks = function combineChunks(_ref2) {
	...
	var defaultFindChunks = function defaultFindChunks(_ref3) {
	  ...
	  var caseSensitive = _ref3.caseSensitive;
	 ...
	 */
	var fillInChunks = function fillInChunks(_ref4) {
	  var chunksToHighlight = _ref4.chunksToHighlight;
	  var totalLength = _ref4.totalLength;
	
	  var allChunks = [];
	  var append = function append(start, end, matchType, highlight) {
	    if (end - start > 0) {
	      allChunks.push({
	        start: start,
	        end: end,
